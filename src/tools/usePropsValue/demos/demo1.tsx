 ...
 *         更新值：1、Parent start, Parent render, child start, child render, child trigger useEffect true, child start, child render, child trigger useEffect, child start, child render
 */
...
const Parent = () => {
  ...
  return (
    <div>
      ...
      <div>
        <Input placeholder="受控" value={value} onChange={(value) => setValue(value)} />
      </div>
    </div>
  );
};
